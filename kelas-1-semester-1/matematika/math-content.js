window.GRADE1_MATH_CONTENT = {
  ...
  chapters: [
    { id: 'bab-1', number: 1, title: 'Mengenal Bilangan sampai 10', icon: '🔢', color: 'coral', goal: 'Mengenal, membaca, dan membilang bilangan 0 sampai 10.', subs: [
      { title: 'Bilangan 0 sampai 5', concept: 'Mencocokkan lambang bilangan dengan banyak benda.', activity: { type: 'count', prompt: 'Ada berapa apel?', instruction: 'Ayo hitung apel satu per satu.', items: '🍎', answer: 4, choices: [3, 4, 5] } },
      { title: 'Bilangan 6 sampai 10', concept: 'Membaca dan mengurutkan bilangan sampai 10.', activity: { type: 'choose', prompt: 'Pilih angka 7.', instruction: 'Dengarkan: tujuh. Sekarang pilih angka tujuh.', answer: 7, choices: [6, 7, 8] } }
    ] },
    ...
    { id: 'bab-5', number: 5, title: 'Bilangan sampai 20', icon: '🌟', color: 'violet', goal: 'Membaca, membilang, dan membandingkan bilangan sampai 20.', subs: [
      { title: 'Membilang sampai 20', concept: 'Menghubungkan banyak benda dengan bilangan sampai 20.', activity: { type: 'count', prompt: 'Ada berapa bintang?', instruction: 'Ayo hitung semua bintang sampai selesai.', items: '⭐', answer: 8, choices: [7, 8, 9] } },
      { title: 'Membandingkan Bilangan', concept: 'Menentukan bilangan yang lebih banyak atau lebih besar.', activity: { type: 'compare', prompt: 'Mana yang lebih banyak?', instruction: 'Bandingkan kedua kelompok. Pilih bilangan yang lebih banyak.', answer: '6', choices: ['4', '6', 'Sama banyak'] } }
    ] }
  ]
};
